...
// PaymentApp owns its own <Routes> (nested invoice/line-item sub-routes),
// so standalone mode needs its own <BrowserRouter> too — in production
// this comes from the Shell's single <BrowserRouter> instead (see
...
// deployed: "/" for local dev (localhost:5003), "/mfe/payment" for the
// Vercel static demo, and "/mfe/releases/<release>/payment" under the ship
